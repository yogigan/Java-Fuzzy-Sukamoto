...
public class VKeterangan {
    ...
    public static double tidaklolos() {
        if (keterangan >= titik1 && keterangan <= titik2) {
            return 1;
        } else if (keterangan >= titik2 && keterangan <= titik3) {
            return (keterangan - titik2) / (titik3 - titik2);
        } else {
            return 0;
        }
    }
    ...
    public static double cadangan() {
        if (keterangan >= titik2 && keterangan <= titik4) {
            return 1;
        } else if (keterangan >= titik2 && keterangan <= titik3) {
            return (keterangan - titik2) / (titik3 - titik2);
        } else if (keterangan >= titik3 && keterangan <= titik4) {
            return (titik4 - keterangan) / (titik4 - titik3);
        } else {
            return 0;
        }
    }
